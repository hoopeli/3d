...
void drawInstructions() {
  ...
  text("Hiiri", 0, 40);
  textSize(20);
  text("Oikea/rulla - Zoomaus...", 0, 70);
  text("Vasen - Siirrä näkymää...", 0, 100);
  text("Keski - Siirry kaksiulotteisesti...", 0, 130);
  text("Tuplaklikkaus - Palaa alkunäkymään...", 0, 160);
  textSize(30);
  text("Näppäimistö", 0, 190);
  textSize(20);
  text("A - Aktivoi törmäystarkastelu seiniin...", 0, 220);
